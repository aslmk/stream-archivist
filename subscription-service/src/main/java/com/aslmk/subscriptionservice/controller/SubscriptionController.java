...
public class SubscriptionController {
    ...
    public void subscribe(@NotNull @RequestHeader(GatewayHeaders.USER_ID) UUID userId,
    ...
    public UserSubscriptionsResponse getUserSubscriptions(
            @NotNull @RequestHeader(GatewayHeaders.USER_ID) UUID userId) {
        return service.getAllUserSubscriptions(userId);
    }

    @DeleteMapping
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void unsubscribe(@NotNull @RequestHeader(GatewayHeaders.USER_ID) UUID userId,
                            @NotNull @RequestParam(name = "streamerId") UUID streamerId) {
