...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, UploadCompletedEvent> consumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(
                ...
                new JsonDeserializer<>(UploadCompletedEvent.class));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, UploadCompletedEvent> kafkaListenerContainerFactory(
            ConsumerFactory<String, UploadCompletedEvent> consumerFactory
    ) {
        ConcurrentKafkaListenerContainerFactory<String, UploadCompletedEvent> factory = new ConcurrentKafkaListenerContainerFactory<>();
